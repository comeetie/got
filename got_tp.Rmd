...
Servez vous de la table characters pour trouver les 5 plus grands meutriers de la série.
```
...
La table spatiale `data/GoTRelease/ScenesLocations.shp` vous donnera les localisations des lieux référencés dans la table scène.
```
